...
while True:
    ...
    #pose_T, pose_R, pprev_prev_cloud, prev_current_cloud = VO_KITTI.calc_trajectory()
    ...
    #    plt.scatter(pprev_prev_cloud[i][0] + pose_T[0][0], pprev_prev_cloud[i][2] + pose_T[2][0], c='red')
    #    plt.scatter(prev_current_cloud[i][0] + pose_T[0][0], prev_current_cloud[i][2] + pose_T[2][0], c='green')
