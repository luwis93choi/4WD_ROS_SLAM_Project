...
X = np.random.rand(data_num, 2) * val_range

print(X)

clustering = AgglomerativeClustering(n_clusters=None, linkage='ward', distance_threshold=25.0).fit(X)

print(clustering)

print(clustering.labels_)

plot_clustering(X, clustering.labels_)
